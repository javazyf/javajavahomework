...
CREATE TABLE `user` (
  ...
  `user_purse` int(11) NOT NULL,
  `user_root` int(11) NOT NULL,
  `user_qiandao` tinyint(4) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `user` VALUES (2016001,'123','123','333','true','2016-12-14 17:53:11','13123390273','2016000100',0,0,0),(2016002,'877','1233','555','fakse','2016-12-09','12345678901','hhsjshs@hhah.cn',10,0,0);
