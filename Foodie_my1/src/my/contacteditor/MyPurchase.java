...
public class MyPurchase extends javax.swing.JFrame {

	  long user_id;
	    public MyPurchase(long user_id) {
	        ...
	        a = userserdb.search_buyid(user_id); //搜索用户购买菜谱，输入用户ID返回为帖子id数组
			int number=a.size();
	        ...
	        String post_title=postSerDB.gettitle(b[i]);  //获得帖子标题
	        ...
	        UserSerDB userSerDB= new UserSerDB();   //获得帖子作者
	    ...
	    private void LogoutActionPerformed(java.awt.event.ActionEvent evt) {
	        MyPurchase.this.setVisible(false);
