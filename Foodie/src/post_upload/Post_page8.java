...
public class Post_page8 extends javax.swing.JFrame {
	
	private int progress1=8; //步骤
    ...
    public Post_page8(long post_id,long user_id) {
      ...
      //页面布局
        ...
        cancel1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {//设置上取消监听事件
        ...
        previous1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {//设置上一步监听事件
            	try {
        ...
        next1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {//设置下一步监听事件
                next1ActionPerformed(evt);
            }
        });

        issue1.setText("发布");
        issue1.addActionListener(new java.awt.event.ActionListener() { //设置发布监听事件
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void previous1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
		//上一步监听
    	setVisible(false);
    	Post_page7 p_p1=new Post_page7(post_nowid,post_wrid);
    ...
    private void next1ActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	setVisible(false);
    	Post_page9 p_p1=new Post_page9(post_nowid,post_wrid);////调用Post_page2，进入下一步
    	p_p1.setVisible(true);
    }
