...
public class Post_page10 extends javax.swing.JFrame {
	
	private int progress1=10;//步骤
    ...
    public Post_page10(long post_id,long user_id) {
    ...
    private void previous1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
    	//上一步监听
    	setVisible(false);
    	Post_page9 p_p1=new Post_page9(post_nowid,post_wrid);
