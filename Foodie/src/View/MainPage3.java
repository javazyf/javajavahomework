...
/*@author vivian
 */
public class MainPage3 extends javax.swing.JFrame {

    long user_id;
    
    public MainPage3(long user_id) {
        ...
        f=UserSerDB.search_follow_id(user_id);
      
        for(int i=0;i<f.size();i++){
        	for(int j=0;j<f.size();j++){
        		a.add(postserdb.getpost_id(Long.valueOf(f.get(i).toString())).get(j));
        	}
        }
  ...
  /*      javax.swing.GroupLayout postLayout = new javax.swing.GroupLayout(post[i]);
    ...
    private void private_postActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_private_postActionPerformed
       MainPage3.this.setVisible(false);
    ...
    private void save_postActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_postActionPerformed
       MainPage3.this.setVisible(false);
       new MainPage2(user_id).setVisible(true);        // TODO add your handling code here:
